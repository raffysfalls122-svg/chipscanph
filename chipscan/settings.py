...
# ALLOWED_HOSTS is set to '*' to allow devices on the same WiFi network (e.g. mobile phones)
# to access the Django server at the host's IP address.
ALLOWED_HOSTS = ['*']
...
# Database
# Using local, persistent SQLite file
DATABASES = {
    'default': {
